...
export default props =>
  <ShapeWrapper>
    <svg width="60px" height="25px" viewBox="0 0 60 25" preserveAspectRatio="none" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="hover-text" fill={props.color || "#231F20"}>
            <g id="Fill-1">
